...
const TermsOfUse = ({ setTermsOfUseState }) => {
    return (
        <div className="term-container">
            <div className="btn-container">
                <button
                    className="btn close-button"
                    onClick={() => setTermsOfUseState(false)}
                >
                    CLOSE
                </button>
            </div>
            <h1>TERMS OF USE Last</h1>
            <article>
                ...
                <ul>
                    ...
                    <li>
                        ...
                        refers to Chandos Construction , 9604 20 Ave NW,
                        Edmonton, AB T6N 1G1.
                    </li>
                    <li>
                    ...
                    <li>
                        ...
                        Conditions agreement as been created with the help
                        of&nbsp;
                        <a
                    ...
                    <li>
                        <strong>Website</strong>&nbsp;refers to Chandos
                        Construction, accessible from www.chandos.com
                    </li>
                    <li>
                ...
                <p>
                    ...
                    Service. You also confirm that all logos, images, copy,
                    documents and any other material found on the Website are
                    the sole property of Chandos Construction and may not be
                    used, duplicated or reproduced without consent.&nbsp;
                </p>
                ...
                <p>
                    ...
                    by You through the Service&nbsp;if You haven't purchased
