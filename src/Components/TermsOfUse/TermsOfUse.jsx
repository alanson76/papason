        ...
        <div className="term-container">
            ...
            <article>
                ...
                <ul>
                    ...
                    <li>
                        <p>
                            <strong>Country</strong> refers to: British
                            Columbia, Canada
                        </p>
                    </li>
                    <li>
                        <p>
                            ...
                            refers to Papason Home Builders, 21155 Cook Ave.
                            Maple Ridge BC V2X 7P7.
                        </p>
                    </li>
                    <li>
                        <p>
                    ...
                    <li>
                        <p>
                            ...
                            Service. This Terms and Conditions agreement has
                    ...
                    <li>
                        <p>
                            <strong>Website</strong> refers to Papason Home
                            Builders, accessible from{" "}
                            <a
                                href="papasonhomes.github.io"
                                rel="external nofollow noopener"
                                target="_blank"
                            >
                                papasonhomes.github.io
                            </a>
                        </p>
                    </li>
                    <li>
                ...
                <ul>
                    <li>
                        <p>
                            ...
                            <a
                                ...
                                class="__cf_email__"
                                data-cfemail="6212031203110d0c0a0d0f0722050f030b0e4c010d0f"
                            >
                                [email&#160;protected]
                            </a>
                        </p>
                    ...
                    <li>
                        <p>
                            ...
                            <a
                                href="https://papasonhomes.github.io/"
                                rel="external nofollow noopener"
                                target="_blank"
                            >
                                https://papasonhomes.github.io/
                            </a>
                        </p>
                    </li>
                </ul>
